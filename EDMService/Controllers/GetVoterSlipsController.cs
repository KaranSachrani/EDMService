...
{
    public class GetVoterSlipsController : ApiController
    {
        [Route("api/GetVoterSlips/{blockcode}")]
        public string Get(string blockcode)
        {

            
            string sql = "SP_Voter_Slip_BlockCode  '" + blockcode + "'";
